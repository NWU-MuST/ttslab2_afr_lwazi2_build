...
def make_voice(langs, synthfile="frontend"):
    ...
    for i, lang in enumerate(langs):
        if i == 0:
            exec("from ttslab.lang.%(lang)s import Prasa16Voice as Voice" % {"lang": lang})
            langpref = "main"
        else:
            langpref = lang
        pronun[langpref] = {}
        ...
        pronun[langpref]["g2ps"] = ttslab.fromfile(langpref + G2PS_FILESUFFIX)
